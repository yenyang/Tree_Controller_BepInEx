    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "YY_TREE_CONTROLLER_DESCRIPTION.building-or-net", "Selects every tree in a whole building or network. You cannot change prefabs of trees in nets." },
                { "YY_TREE_CONTROLLER.single-tree", "Single Tree" },
                { "YY_TREE_CONTROLLER_DESCRIPTION.single-tree", "Selects a single tree in a building, net, or on the map. You cannot change prefabs of trees in nets." },
                { "YY_TREE_CONTROLLER.radius", "Radius" },
                { "YY_TREE_CONTROLLER_DESCRIPTION.radius", "Selects every tree in a radius including those in buildings, nets, or on the map. You should avoid changing prefabs of trees in nets." },
                { "YY_TREE_CONTROLLER.whole-map", "Whole Map" },
                { "YY_TREE_CONTROLLER_DESCRIPTION.whole-map", "Selects all trees in every building, net, or on the map. Be careful how you use this. Right click to apply. You should avoid changing prefabs of trees in nets." },
                ...
                { "YY_TREE_CONTROLLER.clear-ages", "Clear Ages" },
