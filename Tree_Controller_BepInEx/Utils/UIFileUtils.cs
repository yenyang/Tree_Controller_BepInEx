    ...
    internal static class UIFileUtils
    {
        ...
        public static string AssemblyPath
        {
            get
            {
                ...
                {
                    s_assemblyPath = Path.GetDirectoryName(typeof(TreeControllerPlugin).Assembly.Location);
                }
        ...
        internal static void ReadUIFiles(View uiView, string directoryName)
        {
            try
            {
                ...
                {
                    TreeControllerMod.Instance.Logger.Error(new Exception("unable to locate UI file directory "), directoryPath);
                    return;
                }
            ...
            {
                TreeControllerMod.Instance.Logger.Error(e, "exception reading UI files");
            }
        }
        ...
        internal static string ReadHTML(string fileName, string injectionPostfix = "document.body.appendChild(yyTreeController.div);")
        {
            try
            {
                ...
                {
                    return "yyTreeController.div = document.createElement('div'); yyTreeController.div.innerHTML = \"" + EscapeToJavaScript(html) + "\"; " + injectionPostfix;
                }
            }
            catch (Exception e)
            {
                TreeControllerMod.Instance.Logger.Error(e, $" exception reading HTML file {fileName}");
            }
            return null;
        }
        ...
        internal static string ReadHTML(string fileName)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(html))
                {
                    ...
                    return $"yyTreeController.div = document.createElement('div'); yyTreeController.div.innerHTML = \"{EscapeToJavaScript(html)}\"; document.body.appendChild(yyTreeController.div);";
                }
            }
            catch (Exception e)
            {
        ...
        internal static string ReadJS(string fileName)
        {
            ...
            {
                TreeControllerMod.Instance.Logger.Error(e, $" exception reading JS file {fileName}");
            }
        ...
        internal static string ReadCSS(string fileName)
        {
            ...
            {
                TreeControllerMod.Instance.Logger.Error(e, $" exception reading CSS file {fileName}");
            }
        ...
        private static string ReadUIFile(string fileName)
        {
            ...
            {
                TreeControllerMod.Instance.Logger.Error(e, $" exception reading UI file {fileName}");
            }
